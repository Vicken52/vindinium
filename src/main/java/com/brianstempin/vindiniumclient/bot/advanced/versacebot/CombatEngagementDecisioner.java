 ...
 */
public class CombatEngagementDecisioner implements Decision<VersaceBot.GameContext, BotMove> {

    private static final Logger logger = LogManager.getLogger(CombatEngagementDecisioner.class);

    private final Decision<VersaceBot.GameContext, BotMove> yesDecision;
    private final Decision<VersaceBot.GameContext, BotMove> noDecision;

    public CombatEngagementDecisioner(Decision<VersaceBot.GameContext, BotMove> yesDecision,
                                      Decision<VersaceBot.GameContext, BotMove> noDecision) {
